...
class FunctionObject(BaseModel):
    """Function definition"""
    name: str = Field(..., min_length=1, max_length=64, regex=r"^[a-zA-Z0-9_-]+$", description="The name of the function to be called")
...
class ChatCompletionResponseMessageToolCallFunction(BaseModel):
    """Function call in response tool call"""
    name: str = Field(..., description="Model-generated function name")
    arguments: Dict[str, Any] = Field(..., description="JSON format of the function call parameters")

class ChatCompletionResponseMessageToolCall(BaseModel):
    """Tool call in response message"""
    function: ChatCompletionResponseMessageToolCallFunction = Field(..., description="Function call information")
    id: str = Field(..., description="Unique identifier for the tool call")
    type: str = Field(..., description="Tool type called by the model")
...
class ChatCompletionResponseMessage(BaseModel):
    ...
    tool_calls: Optional[List[ChatCompletionResponseMessageToolCall]] = Field(None, description="Function names and parameters generated by the model")

class Choice(BaseModel):
    """Response choice"""
    index: int = Field(..., description="Result index")
    message: ChatCompletionResponseMessage = Field(..., description="Response message")
...
class ToolExecutionResponse(BaseModel):
    """Tool execution response for streaming"""
...
ToolCallFunction.validator('arguments', pre=True, allow_reuse=True)(validate_arguments)
